package com.bruce.carmanager.common.interceptor;
...
public class LoginInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) {
        ...
        if (method.isAnnotationPresent(RequireAdmin.class)) {
            String userRole = Optional.of(loginUserVO).map(LoginUserVO::getRole).map(RoleVO::getRoleId).orElse(RoleEnum.USER.getRoleId());
